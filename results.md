...
<figure>
  <img src="docs/latencyImage.png" alt="Latency Image" style="width:100%">
...
#### Mosquitto + Gateway 
<video src="docs/mosquitto.mov" controls="controls" style="max-width: 400px;">
</video>

#### MusQraTT
<video src="docs/musqratt.mov" controls="controls" style="max-width: 400px;">
</video>